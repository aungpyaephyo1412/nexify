...
const Layout = async ({ params: { slug } }: { params: { slug: string } }) => {
    ...
    <>
      ...
      <div className="">
        ...
        <div className="w-full flex justify-between items-center screen-padding mb-2">
          <div
              className="size-[100px] lg:size-[150px] rounded-full bg-black -mt-[45px] lg:-mt-[70px] border border-blue-500">
          ...
          {session?.user.username === slug ? <EditProfile user={data}/> : <button>Edit</button>}
        </div>
